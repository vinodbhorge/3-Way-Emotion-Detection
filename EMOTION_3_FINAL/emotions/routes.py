...
def mood_text():
    ...
    if form.validate_on_submit():
        ...
        final_labels.append(emotions[preds.index(max(preds))])
       ...
       # plt.savefig('emotions/static/results/graph.jpg')
        ...
        out = emotions[preds.index(max(preds))]
